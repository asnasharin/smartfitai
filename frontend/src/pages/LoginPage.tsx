...
const LoginPage: React.FC = () => {
  ...
  try {
    ...
    if (!data.user || !data.token) {
      toast.error("Invalid server response (missing user)");
        ...
        <div className="min-h-[calc(100vh-80px)] flex">
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
                <div className="w-full max-w-md space-y-6">
                    ...
                    <div className="text-right w-full mb-4">
                        ...
                        <Link
                            to="/signup"
                            className="font-semibold text-theme-blue hover:underline text-sm ml-1"
                        >
                            Sign Up
                        </Link>
                    </div>

                    <h1 className="text-3xl md:text-4xl font-bold text-theme-darkSlate">
                        Welcome Back!
                    </h1>

                    <p className="text-muted-foreground">
                        Log in to access your dashboard, manage resumes,
            ...
            <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-theme-blue to-theme-purple items-center justify-center p-12 text-white flex-col relative overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-6">
                    ...
                    <Quote
                        className="h-12 w-12 text-cyan-300 mx-auto"
                        strokeWidth={1.5}
                    />
                    ...
                    <p className="text-xl font-light text-blue-100 max-w-md mx-auto">
                        "Leverage AI to build a resume that stands out and
                        matches you with the perfect job."
                    </p>
